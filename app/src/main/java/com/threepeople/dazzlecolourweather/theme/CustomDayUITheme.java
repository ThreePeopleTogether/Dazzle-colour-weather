 ...
 * 自定义UI主题.
 */
public class CustomDayUITheme implements UITheme {
    private float oneDp;
    ...
    public CustomDayUITheme(Context context) {
    ...
    public CustomDayUITheme(UITheme theme) {
        if (theme instanceof CustomDayUITheme) {
            CustomDayUITheme that = (CustomDayUITheme) theme;
    ...
    public boolean equals(Object o) {
        ...
        CustomDayUITheme that = (CustomDayUITheme) o;
